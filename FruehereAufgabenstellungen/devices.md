...
- **Migration** und **Update-Database** sind, bei dieser Übung, händisch auszuführen.
...
- Die API bietet für alle drei Entitätstypen die CRUD-Funktionalitäten an.
- Der Endpoint </api/devices/with-counts> gibt die Geräte mit der Anzahl von Buchungen aus.

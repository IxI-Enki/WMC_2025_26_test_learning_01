...
│     ├─ Application/                                                 │
│     │  │                                                            │
│     │  ├─ Features/              !!  NUR Ordnerstruktur VORHANDEN   │
│     │  │  │                                                         │
...
│                                                             │
│     common-issues/                                          │
│     ├─ validation-errors.md             ?! Top 10 Fehler    │
│     ├─ ef-core-migrations.md            ?! DB-Probleme      │
...
│     ├─  !! throw NotImplementedException für den Rest                │
│     ├─  - Tests vorhanden                                            │
...
│     ├─  - Interfaces definiert                                       │
│     ├─  !!  Klassen leer oder Gerüste                                │
│     ├─  !!  Student muss Commands/Queries anlegen                    │
│     ├─  - Tests vorhanden                                            │
...
│     ├─  - Leere Solution                                             │
│     ├─  !!  Student erstellt ALLES selbst                            │
│     ├─  !!  Nur Interface-Definitionen als Hilfe                     │
...
# 2 SOLUTION BRANCH ERSTELLEN (Übung 02)
...
7. !! **README polieren** - Für jeden Schwierigkeitsgrad

...
/// </summary>
public class SensorRepository( AppDbContext ctx )
      : GenericRepository<Sensor>( ctx ),
        ISensorRepository
{
      public async Task<IReadOnlyCollection<GetSensorWithNumberOfMeasurementsDto>> GetAllWithNumberOfMeasurementsAsync( CT ct )
      {
